...
data_path = base_path+"Datasets/vicodi/Train_data/Data.json"
...
kwargs = {"learner_name":"GRU", "emb_model_name":"", 'knowledge_graph_path': base_path+"Datasets/vicodi/vicodi.owl",
          "pretrained_embedding_path":base_path+"Datasets/vicodi/Model_weights/ConEx_GRU.pt",
          "pretrained_concept_synthesizer":base_path+"Datasets/vicodi/Model_weights/GRU.pt", 
