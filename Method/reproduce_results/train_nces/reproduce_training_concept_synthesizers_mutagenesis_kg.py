...
kwargs = {"learner_name":"GRU", "emb_model_name":"", 'knowledge_graph_path': base_path+"Datasets/mutagenesis/mutagenesis.owl",
          "pretrained_embedding_path":base_path+"Datasets/mutagenesis/Model_weights/ConEx_GRU.pt",
          "pretrained_concept_synthesizer":base_path+"Datasets/mutagenesis/Model_weights/GRU.pt", 
