...
lp_path = currentpath.split("dllearner")[0]+"Datasets/carcinogenesis/Train_data/Data.json"
...
kg_path = currentpath.split("dllearner")[0]+'Datasets/carcinogenesis/carcinogenesis.owl'
...
for model in ['ocel', 'eltl', 'celoe']:
    ...
    with open(currentpath.split("dllearner")[0]+'Datasets/carcinogenesis/Results/concept_learning_results_'+model+'.json', 'w') as file_descriptor1:
                json.dump(Result_dict, file_descriptor1, ensure_ascii=False, indent=3)

    with open(currentpath.split("dllearner")[0]+'Datasets/carcinogenesis/Results/concept_learning_avg_results__'+model+'.json', 'w') as file_descriptor2:
