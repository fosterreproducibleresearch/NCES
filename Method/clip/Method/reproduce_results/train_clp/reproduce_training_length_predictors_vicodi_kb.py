...
kwargs = {"learner_name":"GRU", "emb_model_name":"", "pretrained_embedding_path":base_path+"Datasets/vicodi/Model_weights/ConEx_GRU.pt", "pretrained_length_learner":base_path+"Datasets/vicodi/Model_weights/GRU.pt", "path_to_csv_embeddings":base_path+"Embeddings/vicodi/ConEx_entity_embeddings.csv",
