...
data_path = base_path+"Datasets/family-benchmark/Train_data/Data.json"
...
kwargs = {"learner_name":"GRU", "emb_model_name":"", "pretrained_embedding_path":base_path+"Datasets/family-benchmark/Model_weights/ConEx_GRU.pt", "pretrained_length_learner":base_path+"Datasets/family-benchmark/Model_weights/GRU.pt", "path_to_csv_embeddings":base_path+"Embeddings/family-benchmark/ConEx_entity_embeddings.csv",
         ...
         "random_seed":1, "embedding_dim":20, "num_entities":len(triples.entities),
          "num_relations":len(triples.relations), "num_ex":202, "input_dropout":0.0, 
          ...
          'seed':10, 'seq_len':202,'kernel_w':5, 'kernel_h':11, 'stride_w':1, 'stride_h':7,
          'conv_out':136, 'mlp_n_layers':4, "as_classification":as_classification}

Models = ["GRU", "LSTM", "CNN"]
print()
print('#'*50)
print('On Family-Benchmark knowledge base')
print('#'*50)
print()
