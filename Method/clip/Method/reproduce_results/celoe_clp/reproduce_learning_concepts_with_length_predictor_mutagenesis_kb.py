...
data_path = base_path+"Datasets/mutagenesis/Learning_problems/Data.json"
...
kb_path = base_path+"Datasets/mutagenesis/mutagenesis.owl"
...
if __name__=='__main__':
    ...
    kwargs = {'knowledge_base': kb,
                     ...
                     "learner_name":"GRU", "emb_model_name":"", "pretrained_embedding_path":base_path+"Datasets/mutagenesis/Model_weights/ConEx_GRU.pt",
                     "pretrained_length_learner":base_path+"Datasets/mutagenesis/Model_weights/GRU.pt",
                     "path_to_csv_embeddings":base_path+"Embeddings/mutagenesis/ConEx_entity_embeddings.csv",
    ...
    with open(base_path+"Datasets/mutagenesis/Results/concept_learning_results_celoe_clp.json", "w") as results_file:
        json.dump(results, results_file, ensure_ascii=False, indent=3)
    with open(base_path+"Datasets/mutagenesis/Results/concept_learning_avg_results_celoe_clp.json", "w") as avg_results_file:
