...
data_path = base_path+"Datasets/vicodi/Learning_problems/Data.json"
with open(data_path, "r") as file:
    data = json.load(file)
data = list(data.items())

path_to_triples = base_path+"Datasets/vicodi/Triples/"
triples = Data({"path_to_triples":path_to_triples})

as_classification = True
kb_path = base_path+"Datasets/vicodi/vicodi.owl"
...
if __name__=='__main__':
    ...
    kwargs = {'knowledge_base': kb,
                     ...
                     "learner_name":"GRU", "emb_model_name":"", "pretrained_embedding_path":base_path+"Datasets/vicodi/Model_weights/ConEx_GRU.pt",
                     "pretrained_length_learner":base_path+"Datasets/vicodi/Model_weights/GRU.pt",
                     "path_to_csv_embeddings":base_path+"Embeddings/vicodi/ConEx_entity_embeddings.csv",
    ...
    with open(base_path+"Datasets/vicodi/Results/concept_learning_results_celoe_clp.json", "w") as results_file:
        json.dump(results, results_file, ensure_ascii=False, indent=3)
    with open(base_path+"Datasets/vicodi/Results/concept_learning_avg_results_celoe_clp.json", "w") as avg_results_file:
